...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const tomVarInput = new (tom_select__WEBPACK_IMPORTED_MODULE_1___default())("#id_tomvar", config);
  ...
  new (tom_select__WEBPACK_IMPORTED_MODULE_1___default())("#id_tompos", configPos);
