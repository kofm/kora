...
urlpatterns = [
    ...
    path("species/autocomplete", views.PlantSpeciesAutocompleteView.as_view(), name="plantspecies_autocomplete"),
    ...
    path("protections/configure", views.protection_configure, name="protection_configure"),
    path("protection-types/<int:pk>/update", views.protection_type_update, name="protection_type_update"),
    path("protection-types/<int:pk>/delete", views.protection_type_delete, name="protection_type_delete"),
    ...
    path("entities/autocomplete", views.EntityAutocompleteView.as_view(), name="entity_autocomplete"),
]
