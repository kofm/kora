...
urlpatterns = [
    ...
    path("variety/<int:pk>", views.plantvariety_detail, name="plantvariety_detail"),
    path("variety/create", views.PlantVarietyCreate.as_view(), name="variety_create"),
    path("variety/<int:pk>/parameters", views.PlantVarietyParametersList.as_view(), name="plantvarietyparameters_list"),
    path("variety/<int:pk>/delete", views.PlantVarietyDelete.as_view(), name="variety_delete"),
    path("variety/name/<int:pk>/delete", views.plantvarietyname_delete, name="denomination_delete"),
    path("variety/<int:pk>/name/create", views.plantvarietyname_create, name="denomination_create"),
    path("variety/name/<int:pk>/update", views.plantvarietyname_update, name="denomination_update"),
    ...
    path("variety/<int:pk>/update", views.PlantVarietyUpdateView.as_view(), name="variety_update"),
