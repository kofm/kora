...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("#add_trait").click(function () {
  // Get the number of actual total trait fields. Needed for processing
  // with Django
  var form_idx = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#id_traits-TOTAL_FORMS").val();
  ...
  // to increment.
  var replacement = jquery__WEBPACK_IMPORTED_MODULE_0___default()("#empty_form")
    .html()
    .replace(/__prefix__/g, form_idx)
    .replace(/([a-z0-9_\-]*?)(-states-)(\d+)/g, "$1$20");
  // Append the html at the end of the form (which has id = form_set
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#form_set").append(replacement);
  // Increment the total number of forms
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("#id_traits-TOTAL_FORMS").val(parseInt(form_idx) + 1);
});
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document.body).on("click", ".add_state", function () {
  // Store the actual number of states within the trait form
  var form_idx = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)
    .closest(".states")
    .find("input:hidden[name$='TOTAL_FORMS']")
    .val();
  // Select the last state within the form
  var prev_state = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this)
    .parent(".card-body")
    .siblings(".list-group")
    .children(".state-form")
    .last();
