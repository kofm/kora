...
urlpatterns = [
    ...
    path("form", dsc.description_form, name="description_form"),
    path("filter/update/expressions", dsc.description_filter_update_expression, name="filter_update_expressions"),
    path("filter/update/name", dsc.description_filter_update_name, name="filter_update_name"),
    path("filter/update/strict", dsc.description_filter_update_strict, name="filter_update_strict"),
