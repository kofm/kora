...
urlpatterns = [
    ...
    path("traits/autocomplete", ac.TraitAutocompleteView.as_view(), name="trait_autocomplete"),
    path("states/autocomplete", ac.StateAutocompleteView.as_view(), name="state_autocomplete"),
