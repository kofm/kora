...
"use strict";
/*!*************************************************!*\
  !*** ./assets/js/description-import-confirm.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
...
document.querySelectorAll(".ts").forEach((el) => {
  ...
  var tomSelectInstance = new (tom_select__WEBPACK_IMPORTED_MODULE_1___default())(el, settings);
